...
//		try {		
//			return new ResponseDTO<>(HttpStatus.OK, "Product Added", userService.getProductById(productId));
//		}catch (RuntimeException e) {
...
//	}
	...
	public ResponseDTO<?> updateProduct(@PathVariable int productId,@RequestBody Product product){
		...
		try {	
			return new ResponseDTO<>(HttpStatus.OK, "Update Product Success", userService.updateProduct(productId, product));
		}catch (RuntimeException e) {
	...
	public ResponseDTO<?> addProduct(@PathVariable String CategoryName, @RequestBody Product product) {
		...
		try {
			return new ResponseDTO<>(HttpStatus.OK, "Added Product Successfully", userService.addProduct(CategoryName, product));
		}catch (RuntimeException e) {
	...
	public ResponseDTO<?> deleteItemFromCart(@PathVariable int productId){
		...
		try {		
			return new ResponseDTO<>(HttpStatus.OK, "Product deleted ", userService.deleteProduct(productId));
		}catch (RuntimeException e) {
	...
	public ResponseDTO<?> editAddress(@PathVariable int userId,@RequestBody Address address){
		...
		try {	
			return new ResponseDTO<>(HttpStatus.OK, "Address Changed successfully", userService.addAddress(userId, address));
		}catch (RuntimeException e) {
	...
	@PutMapping("/getAllCategories")
	public ResponseDTO<?> getAllCategories(){
		System.out.println("in getAllCategories");
		try {	
			return new ResponseDTO<>(HttpStatus.OK, "Address Changed successfully", userService.getAllCategories());
		}catch (RuntimeException e) {
			System.out.println("err in add address : "+e);
			return new ResponseDTO<>(HttpStatus.INTERNAL_SERVER_ERROR, "Address Changed Failed", null);
		}
