                    ...
                    {this.state.products.map(product => 
                        <div className="product col-md-3" key={product.id}>
                            <div className="title"> 
                                ...
                                {product.type === "SALE" &&<><h5 className="nameColor">Rs.{product.finalPrice}</h5><h5 className="nameColor">Rs.<strike>{product.price}</strike><span className="nameColor1">&nbsp; {product.discount}% off</span></h5></>
                                }    
                                {product.type === "RENT" &&<><h5 className="nameColor">Rs.{product.price * 0.10} /day</h5></>
                                }                              
                        ...
                        {product.type === "RENT" &&<button
                            onClick={() => {
                            this.rentProduct(product)
                            }}
                            className="btn btn-sm btn4 btn-add-to-cart">
                            Rent Product
                        </button>}
