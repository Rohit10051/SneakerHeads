...
export default class BookDuration extends Component {
    constructor(props) {
        super(props)
        this.state ={
        bookDuration : '',
    ...
    addProduct = (e) => {
        e.preventDefault();
        window.localStorage.setItem("bookedDuration",this.state.bookDuration);
        this.props.history.push('/rent-details');
    ...
    render(){
        return (
            <div>
                <Navigation />
            <div className="main">
            <Header title="Book Duration" />
            <div className="form">
            <div class="row mb-3">
                <label class="col-sm-2 col-form-label">Book Duration</label>
                <div class="col-sm-10">
                    <input type="text" required autoComplete="off" class="form-control" name="bookDuration" value={this.state.bookDuration} onChange={this.onChange}/>
                </div>
            </div>
            {/* <div class="row mb-3">
...
*/}
            ...
            <div class="row mb-3">
                <label class="col-sm-2 col-form-label">Product For</label>
                <div class="col-sm-10">
