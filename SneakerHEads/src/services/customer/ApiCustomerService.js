...
class ApiCustomerService {
    ...
    fetchProductsById(productId) {
        console.log(USER_API_BASE_URL + '/product/' + productId)
    ...
    addRentDetails(userId, OrderId, bookDuration, productId) {
     bookDuration = JSON.parse(window.localStorage.getItem("bookedDuration"));
     productId = JSON.parse(window.localStorage.getItem("product_id"));
        console.log( USER_API_BASE_URL + '/rentdetails/'+ userId + '/'+ OrderId+ '/' + bookDuration + '/' + productId)
        return axios.get( USER_API_BASE_URL + '/rentdetails/'+ userId + '/'+ OrderId + '/' + bookDuration + '/' + productId);
    }
    //on payment
    ...
    fetchAllCategory(){
        console.log(USER_API_BASE_URL + '/categorylist')
    ...
    getAllCategories(){
        return axios.get(USER_API_BASE_URL + '/getAllCategories/');
    }
    ...
    rentProducts() {
        return axios.get(USER_API_BASE_URL + '/rentProductList/');
    }

    buyProducts() {
        return axios.get(USER_API_BASE_URL + '/buyProductList/');
    }
    
    addRentProduct(totalPrice, userId){
        return axios.get(USER_API_BASE_URL + '/orders-rent/'+userId+'/'+totalPrice)
    }
}
